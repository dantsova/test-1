...
CustomSlider.prototype._init = function ($root, config) {
    ...
    //this._transformStep = 110.3 / itemsInVisibleArea;
    this._scrollValue = _fullScrollValue;
    if(this._widthWrapper<=800){
        this._scrollValue = _partialScrollValue;
    }
    this._transformStep = this._scrollValue / itemsInVisibleArea;
